package com.knight.knightkt.utils;
...
public class MeasureUtil {
    ...
    public static Size measure(int displayAspectRatio, int widthMeasureSpec, int heightMeasureSpec, int videoWidth, int videoHeight) {
        ...
        if (displayAspectRatio == ASPECT_RATIO_ORIGIN) {
            return new Size(videoWidth, videoHeight);//P
